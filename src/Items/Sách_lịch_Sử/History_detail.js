...
import Comments_Ls from "./Comments_Ls";
import ListComment_Ls from "./ListComment_Ls";
...
function History_detail(props) {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:8081/detail_book/${params.id}`)
      .then((res) => {
        console.log(res);
        ...
        >
          <div className="carousel-inner">
            <div className="item active">
              <img
                src={`http://localhost:8081/public/upload/${getData.image_path}`}
                alt={getData.book_title}
              />
      ...
      return (
        <div className="col-sm-7">
          <div className="product-information">
            ...
            <p>
              <b>Brand:</b> {getData.supplier_name}
            </p>
            <p>
              <b>Author:</b> {getData.author}
            </p>
            <p>
              <b>Category:</b> {getData.category_name}
            </p>
            <p>
              <b>Publication Year:</b> {getData.publication_year}
            </p>
            <p>
              <b>Price:</b> {getData.price} VND
            </p>
            <Link
  ...
  return (
    <div className="col-sm-9 padding-right">
      ...
      <ListComment_Ls comments={comments} />
      <Comments_Ls id_comment={params.id} book_id={getData.book_id} />
    </div>
  );
}
